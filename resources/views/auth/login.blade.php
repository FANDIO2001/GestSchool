    ...
    <div class="w-full max-w-md bg-white p-8 rounded-xl shadow-lg border border-gray-200">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    placeholder="••••••••" 
                    required>
                <a href="#" class="block text-right text-sm text-blue-500 hover:text-blue-700 mt-2">Mot de passe oublié ?</a>
            </div>
        ...
        <div class="text-center mt-6">
            <p class="text-gray-600">
                ...
                <a href="{{ route('register') }}" class="text-blue-500 hover:text-blue-700 font-bold">S'inscrire</a>
            </p>
        </div>
